...
export function ReassignDialog({
  ...
  const members = (data ?? []).filter((m) => m.id !== currentAssigneeId);
  ...
  return (
    <Modal
      ...
      titleKey="reassign"
      descriptionKey="reassign-conversation-description"
      size="md"
      footer={
        <>
    ...
    >
      <div className="px-6 pb-6">
        {isLoading ? (
          ...
          <AppSelect
            id="reassign-team-member"
            labelKey="conversation-assignee"
